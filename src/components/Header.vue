  ...
  <div>
    ...
    <v-navigation-drawer app v-model="drawer" color="#000">
       <v-layout column align-center>
        ...
        <v-flex class="mt-5">
          <v-avatar size="100" class="ml-12">
            <img src="@/assets/my.jpg" alt="">
          </v-avatar>
          <p>
            <v-btn text class="title">
              <span class="white--text">Keva Dam</span>
              <span class="grey--text">ar Galih</span>
             </v-btn>
          </p>
        </v-flex>
...
export default {
  data () {
    return {
      drawer: false,
      routes: [
        {link:'/', name:'HOME', icon: 'mdi-home-edit-outline'},
        {link:'/projects', name:'PROJECTS', icon: 'mdi-folder'},
